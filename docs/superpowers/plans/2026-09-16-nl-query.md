...
- [ ] **Step 3: Implement `build_context` and the module scaffolding**
...
- [ ] **Step 4: Run tests to verify the `build_context` tests pass**
...
- [ ] **Step 5: Write the failing tests for `generate_answer`**
...
- [ ] **Step 7: Implement `generate_answer`**
...
- [ ] **Step 4: Add the query box styles**
...
- [ ] **Step 2: Restart the local API server** (it needs the new route)
...
- [ ] **Step 3: Open the dashboard in the browser and ask a question**
...
- [ ] **Step 4: Verify the graceful-failure path**
